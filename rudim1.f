        SUBROUTINE RUDIM1 (iv1,iv2,iv3,iv4,xv5,xv6,xv7,xv8,xv12,xv13)
csingh-------Subroutine added on 08/26/2008 (Sowmitra Singh)------------
csingh-------iv1 = L (panel index) -------------------------------------
...
csingh-------xv5 = XM1 (stores coordinates of panel L1,M)---------------
csingh-------xv6 = XM2 (Stores coordinates of panel L1,M+1)-------------
csingh-------xv7 = XM3 (Stores coordinates of panel L1+1,M+1)-----------
csingh-------xv8 = XM4 (Stores coordinates of panel L1+1,M)-------------
        INCLUDE 'PUFCAV.INC'
        INCLUDE 'PUFCAVB.INC' 
...
10         CONTINUE
           ...
           CALL RPAN (XLOC,YLOC,ZLOC,CHRLEWS(iv1),FS,FD,FSX,
